...
# TEMP fix for auth token error in vue
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': datetime.timedelta(days=15),
    'REFRESH_TOKEN_LIFETIME': datetime.timedelta(days=15),
}

# fix for error 500 on user creation, log confirmation mail in console instead of trying to send it
EMAIL_BACKEND = 'django.core.mail.backends.console.EmailBackend'


#loggin in console for debug
LOGGING = {
    'version': 1,
